...
function preload() {
  ...
  var url = "http://api.openweathermap.org/data/2.5/weather?q=San%20Francisco&units=imperial&APPID=e812164ca05ed9e0344b89ebe273c141";
  json = loadJSON(url);
